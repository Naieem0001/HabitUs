...
import { Flame, Github, Home } from 'lucide-react';
...
>>>>>>> 296cdae349dc4e1124b930f5ab7a90b540774481
...
>>>>>>> 296cdae349dc4e1124b930f5ab7a90b540774481
          ...
          <div className="inline-flex items-center gap-3 bg-surface/80 backdrop-blur border border-border rounded-2xl p-4 shadow-xl">
            ...
            <div>
              ...
              <div className="text-muted-foreground text-xs uppercase tracking-wider font-semibold">streaks active right now</div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full md:w-120 lg:w-140 bg-surface/95 backdrop-blur border border-border flex flex-col justify-center items-center p-8 lg:p-16 relative">
        ...
        <div className="w-full max-w-sm fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="mb-10">
            ...
            <h2 className="text-3xl font-bold text-foreground mb-2 tracking-tight">Sign in to your squad</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="relative flex items-center py-4">
              ...
              <span className="shrink-0 mx-4 text-muted-foreground text-sm font-medium">— or —</span>
              <div className="grow border-t border-border"></div>
            </div>
